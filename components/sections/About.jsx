    ...
    <section className="bg-[#f6f9f2]/80 py-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid items-center gap-12 md:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#1d2320]">About Prime Agency</p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <span className="rounded-full border border-[#1d2320]/10 bg-white px-3 py-2 text-sm text-slate-700">Personalized guidance</span>
              <span className="rounded-full border border-[#1d2320]/10 bg-white px-3 py-2 text-sm text-slate-700">Top-rated carriers</span>
              <span className="rounded-full border border-[#1d2320]/10 bg-white px-3 py-2 text-sm text-slate-700">Clear benefit explanations</span>
            </div>
          </div>
          ...
          <div className="grid gap-5">
            ...
            <div className="soft-card rounded-[2rem] p-8">
              ...
              <ul className="mt-6 space-y-3 text-slate-700">
                <li className="rounded-2xl border border-[#1d2320]/10 bg-[#f8fbf5] px-4 py-3">• Personalized guidance with no pressure</li>
                <li className="rounded-2xl border border-[#1d2320]/10 bg-[#f8fbf5] px-4 py-3">• Access to top-rated carriers</li>
                <li className="rounded-2xl border border-[#1d2320]/10 bg-[#f8fbf5] px-4 py-3">• Clear explanations of benefits and costs</li>
              </ul>
            </div>
          </div>
        </div>
