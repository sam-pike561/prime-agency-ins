  ...
  return (
    <PageLayout>
      <div className="bg-[#f6f9f2] pb-8 md:pb-12">
                ...
                <div className="mx-auto w-full max-w-[390px] space-y-4">
                  ...
                  <div className="w-full rounded-[1.5rem] border border-[#dce8de] bg-white p-4 shadow-[0_20px_45px_rgba(15,23,42,0.1)] md:p-5">
                    ...
                    <div className="mb-3 flex items-center justify-between gap-3">
                      <p className="text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-[#163f15]">What drives us</p>
                    ...
                    <div className="space-y-3">
                      {visualCards.map((card) => (
                        <div key={card.label} className="flex items-center justify-between rounded-2xl bg-[#f4f9f2] px-3 py-2.5">
                          ...
                          <span className="text-sm font-semibold text-[#163f15]">{card.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-6xl rounded-[2rem] border border-[#dae7d6] bg-white p-6 shadow-[0_30px_80px_rgba(15,23,42,0.05)] md:p-8 lg:p-10">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              ...
              <div className="relative overflow-hidden rounded-[1.8rem] border border-[#dfe9e1] bg-[#163f15] p-5 md:p-6">
                ...
                />
                <div className="absolute inset-x-8 bottom-8 rounded-[1.4rem] border border-white/20 bg-[#163f15]/85 p-4 text-white shadow-[0_20px_40px_rgba(10,20,12,0.28)] backdrop-blur-sm md:p-5">
        ...
        <Section className="pt-0">
          <div className="mx-auto max-w-6xl rounded-[2rem] border border-[#dfe9e1] bg-[#f3f8f2] p-7 shadow-[0_30px_70px_rgba(15,23,42,0.04)] md:p-10">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <div>
                <p className="text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-[#163f15]">Our values</p>
              ...
              <div className="rounded-[1.8rem] bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.05)] md:p-6">
                <p className="text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-[#163f15]">Ready to get started?</p>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <a href="/contact" className="inline-flex items-center justify-center rounded-full bg-[#163f15] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#1e4a1d]">
                    Contact us
                  </a>
                  <a href="tel:18885922128" className="inline-flex items-center justify-center rounded-full border border-[#163f15]/20 bg-[#f6faf5] px-5 py-3 text-sm font-semibold text-[#163f15] transition hover:bg-[#eff7ee]">
                    1 (888) 592-2128
                  </a>
                </div>
              </div>
        ...
        <Section className="pt-0">
          <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-[#dce8d7] bg-[#163f15] shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
            <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="flex items-center justify-center p-7 md:p-9 lg:p-12">
                <a
                  href="/careers#apply"
                  className="inline-flex items-center justify-center rounded-full bg-white px-7 py-3.5 text-sm font-semibold text-[#163f15] shadow-[0_18px_35px_rgba(10,24,12,0.2)] transition hover:-translate-y-0.5 hover:bg-[#edf7ee]"
                >
                  Apply now
                </a>
              </div>
